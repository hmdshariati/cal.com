...
export function ShellMain(props: LayoutProps) {
  ...
  return (
    <>
      <div className="mb-6 flex h-[36px] items-center sm:mt-0 lg:mb-8">
        {!!props.backPath && (
          <Button
            variant="icon"
            size="sm"
        ...
        {props.heading && (
          <header className={classNames(props.large && "py-8", "flex w-full max-w-full items-center")}>
            ...
            <div className={classNames("w-full ltr:mr-4 rtl:ml-4 sm:block", props.headerClassName)}>
              {props.heading && (
                <h1 className="font-cal max-w-28 sm:max-w-72 md:max-w-80 mt-1 hidden truncate text-xl font-semibold tracking-wide text-black sm:block xl:max-w-full">
